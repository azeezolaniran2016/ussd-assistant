...
const PrivacyPage = () => (
  ...
  >
    <h1> USSD Assistant Privacy Policy </h1>
    <hr />
    <p>Last updated: 12/03/2017</p>
    <p>
      Olaniran Azeez (<span className="highlight-text">us</span>,
      <span className="highlight-text">we</span>, or <span className="highlight-text">our</span>)
      designed and developed
      <a
        href="https://play.google.com/store/apps/details?id=com.olaniran.android.ussdassistant"
      >
        USSD Assistant
      </a> (the <span className="highlight-text">App</span>).
    </p>
    <p>
      This page informs you of our policies regarding the collection, use and disclosure of Personal
      Information we receive from users of the App. We use your Personal Information only for
      providing and improving the App. By using the App, you agree to the collection and use of
    ...
    <p>
      This Privacy Policy is effective as of 12/03/2017 and will remain in effect except with
      ...
      <br />
      If we make any material changes to this Privacy Policy, we will notify you by placing a
